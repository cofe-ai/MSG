...
def main():
    ...
    if args.dataset_name is not None:
        ...
        raw_datasets = load_dataset(args.dataset_name, args.dataset_config_name, cache_dir="/home/yaoyiqun/huggingface/datasets")
    else:
        data_files = {}
        if args.train_file is not None:
    ...
    if args.model_name_or_path:
        model = AutoModelForQuestionAnswering.from_pretrained(
            ...
            config=config,
            cache_dir="/home/yaoyiqun/huggingface/models"
        )
    ...
    logger.info(f"best metric over all: {best_metric}")
